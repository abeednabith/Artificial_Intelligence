...
def gradient_descent(ages, weights, sbp):
    ...
    for i in range(iterations):
        ...
        theta0_der = (1/n) * sum(y_predicted - sbp)
        theta1_der = (1/n) * sum((y_predicted - sbp) * ages)
        theta2_der = (1/n) * sum((y_predicted - sbp) * weights)
        ...
        print(
            f"theta0: {theta0}, theta1: {theta1}, theta2: {theta2}, cost: {cost_fun}, h1: {theta0 + theta1 * 65 + theta2 * 85}, h2: {theta0 + theta1 * 79 + theta2 * 80}")
